 ...
 */
var pavel = User(name: "Pavel", age: 27, height: 184, weight: 80, activityLevel: 10)
print("\(pavel.name), \(pavel.age), \(pavel.height), \(pavel.weight), \(pavel.activityLevel)")
/*:
 ...
 */
let oneHundredfeet = Distance(feet: 100)
print(oneHundredfeet.meters)
