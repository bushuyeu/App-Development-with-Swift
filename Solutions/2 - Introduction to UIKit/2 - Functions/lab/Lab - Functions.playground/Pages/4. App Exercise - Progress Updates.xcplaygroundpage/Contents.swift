...
func pacing (currentDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double) {
    let nessVelocity = (totalDistance - currentDistance)/(goalTime - currentTime)
    let currVelocity = currentDistance / currentTime
    currVelocity >= nessVelocity ? print("Keep it up") : print("You've got to push it just a bit harder!")
    }
