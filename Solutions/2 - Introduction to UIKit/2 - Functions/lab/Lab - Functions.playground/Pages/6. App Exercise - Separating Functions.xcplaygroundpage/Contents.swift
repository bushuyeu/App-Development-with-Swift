...
func calculatePace (currentDistance: Double, totalDistance: Double, currentTime: Double) -> Double {
    let avgVelocity = currentDistance / currentTime
    let timeToFinish = (totalDistance - currentDistance) * avgVelocity
    let expectedTime = currentTime + timeToFinish
    return expectedTime
}
/*:
...
print(pacing(currentDistance: 10, totalDistance: 15, currentTime: 4, goalTime: 3))
