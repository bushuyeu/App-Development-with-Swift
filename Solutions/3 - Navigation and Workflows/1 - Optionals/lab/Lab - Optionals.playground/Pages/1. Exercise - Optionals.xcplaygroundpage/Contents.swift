 ...
 */
print("String that contains not only integers returns nil if converted to Int type")
/*:
 ...
 */
let user2InputAge: String = "34"
let user2Age: Int? = Int(user2InputAge)
print(user2Age)
/*:
...
if let user2ageNonOptional = user2Age {
    print(user2ageNonOptional)
}
